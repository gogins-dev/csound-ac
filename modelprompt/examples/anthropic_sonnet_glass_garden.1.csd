...
Pulse must not overwhelm other voices.
...
- Pulse is the new lead at double the prior Pulse tempo: about 28 to 40 Pulse
  notes, durations .25 to 1, with roughly half the inter-onset spacing of
  a moderate motoric pulse (very tight successive onsets).
- Pulse must have swelling attack and fading decay. Should not mask other sounds.
...
However, make the Pulse instrument have a gradual attack and gradual decay.
instr Glass
  iamp = p4
  ifreq = p5
